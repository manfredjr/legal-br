...
> Ao transcrever texto legal literal, confirme em `fontes/leis/02-cdc-lei-8078-1990-compilado.html`.
>
...
Para a execução da Política Nacional das Relações de Consumo, contará o
...
Os direitos previstos neste código não excluem outros decorrentes de tratados
...
Parágrafo único. É proibida a publicidade de bens
...
(Incluído pela Lei nº 12.039, de
2009)
...
§ 1º As
informações referidas no art. 52 deste Código e no
caput
...
Parágrafo
único. O descumprimento de qualquer dos deveres previstos no
caput
...
do contrato de crédito que lhe seja conexo, nos termos do
caput
...
informações de que tratam o art. 52 e o
caput
...
Referência (Ufir), ou índice equivalente que venha a substituí-lo. (Parágrafo acrescentado pela Lei nº 8.703, de 6.9.1993)
...
§ 5º O
pedido do consumidor a que se refere o
caput
