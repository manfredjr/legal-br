...
| E-mail para titulares de dados | [PREENCHER] |
| Telefone | [PREENCHER] |
| Canal de atendimento ao consumidor | [PREENCHER] |
...
Para quem vão os arquivos `CONSULTA-ADVOGADO-*.md`.
...
| OAB | [PREENCHER] |
| E-mail | [PREENCHER] |
| Escritório | [PREENCHER] |

## Padrões contratuais

Valores padrão que a empresa já decidiu. Deixe em branco o que ainda for decisão caso a caso.
...
| Prazo de aviso para rescisão | [PREENCHER] |
| Retenção padrão de logs | [PREENCHER] |
